...
def send_server_telegram_alert(signature: str, new_pool: dict[str, Any], custom_message: str | None = None) -> None:
    """
    Send a notification to Telegram.
    If custom_message is provided, use it instead of the default message.
    """
    if custom_message:
